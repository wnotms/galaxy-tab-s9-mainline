...
PATTERNS = {
    ...
    "dyndbg_enter": re.compile(r"GTS9WIFI: dynamic_debug_init enter"),
    "dyndbg_walk": re.compile(r"GTS9WIFI: dynamic_debug_init walk i="),
    "dyndbg_cmp_before": re.compile(r"GTS9WIFI: dynamic_debug_init cmp_before i="),
    "dyndbg_cmp_after": re.compile(r"GTS9WIFI: dynamic_debug_init cmp_after i="),
    "dyndbg_add_begin": re.compile(r"GTS9WIFI: dynamic_debug_init add_begin i="),
    "dyndbg_add_done": re.compile(r"GTS9WIFI: dynamic_debug_init add_done i="),
    "dyndbg_walk_done": re.compile(r"GTS9WIFI: dynamic_debug_init walk_done"),
    "dyndbg_final_add_done": re.compile(r"GTS9WIFI: dynamic_debug_init final_add_done"),
    "dyndbg_before_parse": re.compile(r"GTS9WIFI: dynamic_debug_init before_parse_args"),
    "dyndbg_after_parse": re.compile(r"GTS9WIFI: dynamic_debug_init after_parse_args"),
...
STAGES = (
    ...
    ("dyndbg_after_parse", "DYNAMIC_DEBUG_AFTER_PARSE"),
    ("dyndbg_before_parse", "DYNAMIC_DEBUG_BEFORE_PARSE"),
    ("dyndbg_final_add_done", "DYNAMIC_DEBUG_FINAL_ADD_DONE"),
    ("dyndbg_walk_done", "DYNAMIC_DEBUG_WALK_DONE"),
    ("dyndbg_add_done", "DYNAMIC_DEBUG_ADD_DONE"),
    ("dyndbg_add_begin", "DYNAMIC_DEBUG_ADD_BEGIN"),
    ("dyndbg_cmp_after", "DYNAMIC_DEBUG_CMP_AFTER"),
    ("dyndbg_cmp_before", "DYNAMIC_DEBUG_CMP_BEFORE"),
    ("dyndbg_walk", "DYNAMIC_DEBUG_WALK"),
    ("dyndbg_enter", "DYNAMIC_DEBUG_ENTER"),
...
def main():
    ...
    p.add_argument(
        "--config-profile",
        choices=("bringup", "s9u-control", "s9u-nobti", "s9u-va48", "s9u-va48-norelr"),
        default="bringup",
